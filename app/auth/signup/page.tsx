...
export default function SignupPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F8FAFC] to-[#F1F5F9] flex flex-col items-center justify-center p-4 py-12 font-sans text-[#0F172A]">
      <div className="w-full max-w-lg">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 text-[#6366F1] text-xs font-bold font-mono">
            <Sparkles className="w-3.5 h-3.5 text-[#EC4899]" /> Create Patient Account
          </div>
        </div>

        <Card title="Patient Registration" subtitle="Sign up for instant appointment booking and digital medical records." hoverable={false} className="shadow-md border-[#E2E8F0]">
          <SignupForm />
        </Card>
      </div>
    </div>
